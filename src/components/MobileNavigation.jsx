...
const MobileNavigation = ({ isOpen, onClose, onPageChange, onboardingCompleted }) => {
  const [contractorName, setContractorName] = React.useState('Acme HVAC and Cooling');
  const [contractorEmail, setContractorEmail] = React.useState('ariddle@acdrainwiz.com');
  const [fullName, setFullName] = React.useState('Diana Rivera');
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mobile-contractor-card">
        ...
        <div className="mobile-nav-menu">
          <ul>
            ...
            <li>
              <a 
                className={`mobile-nav-link ${currentPath === '/manage-service-calls' ? 'active' : ''}`} 
            ...
            <li>
              <a 
                className={`mobile-nav-link ${currentPath === '/manage-clients' ? 'active' : ''}`} 
                href="/manage-clients" 
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
            ...
            <li>
              <a 
                className={`mobile-nav-link ${currentPath === '/manage-employees' ? 'active' : ''}`} 
        ...
        <div className="mobile-nav-bottom">
          <div className="mobile-nav-support">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon">
          ...
          <div className="mobile-nav-legal">
            <a href="#" className="mobile-nav-legal-link">Terms</a>
            <a href="#" className="mobile-nav-legal-link">Privacy</a>
            <a href="#" className="mobile-nav-legal-link">Cookies</a>
          </div>
